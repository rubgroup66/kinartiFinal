...
public class DBservices
{
    ...
    private String BuildInsertProjCommand(Project proj)
    {
        ...
        StringBuilder sb = new StringBuilder();
        // use a string builder to create the dynamic string
        sb.AppendFormat("Values('{0}', '{1}', '{2}', '{3}', '{4}', '{5}','{6}', {7})", proj.project_name, proj.description , proj.architect, proj.supervisor , proj.customer_id , 0, proj.create_date.Date.ToString("yyyy/MM/dd"), 0);
        // sb.AppendFormat("Values('{0}', '{1}', '{2}', '{3}', '{4}', '{5}','{6}', {7})", proj.project_name, proj.description , proj.architect, proj.supervisor , proj.customer_id , 0, DateTime.ParseExact(proj.create_date, "yyyy/MM/dd", CultureInfo.InvariantCulture), 0);
